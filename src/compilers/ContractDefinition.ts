...
export class ContractDefinition extends AbstractSimpleCompiler {
    static TYPE = `${TemplateMarkModel.NAMESPACE}.ContractDefinition`;
    constructor() {
        super(false);
    }
    getNode(templateMarkNode:IContractDefinition) {
        return {
            $class: `${CiceroMarkModel.NAMESPACE}.Contract`,
            name: templateMarkNode.name,
            nodes: []
        } as IContract;
    }
}