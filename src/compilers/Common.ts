...
export function writeProlog(fw:FileWriter, level:number, templateClass:ClassDeclaration) {
    fw.writeLine(level, `export function generator(data:TemplateModel.I${templateClass.getName()}, library:any, options:Runtime.GenerationOptions) : CommonMark.IDocument {`);
